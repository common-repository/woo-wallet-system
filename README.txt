...
It help us to online payments.

== Description ==

This plugin help us for online payment we can add money WooCommece payment method to the wallet. WooCommerce plugin is required for this plugin.
...
3. Click **" Install "**
4. Click **" Active "**
1. You need to add other one payment method for add money in the wallet.
...
1. Wallet option tab in the My Account page.
